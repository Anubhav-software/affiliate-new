...
export const RecentTransactions = () => {
  return (
    <div className="col-span-8 p-4 -mt-[478px] rounded border border-stone-300">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="flex items-center gap-1.5 font-medium text-xl">
          <FiDollarSign /> Listings Last 2 Weeks 
        </h3>
        <button className="text-xl text-violet-500 hover:underline">
          See all
        </button>
      </div>
...
const TableRow = ({ cusId, sku, date, price, order }) => {
  return (
    <tr className={order % 2 ? "bg-stone-100 text-base" : "text-sm"}>
      <td className="p-1.5">
        <a
          href="#"
